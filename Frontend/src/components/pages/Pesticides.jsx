...
const Pesticide = () => {
  ...
  useEffect(() => {
    ...
    setTimeout(() => {
      fetch("https://kumarfertilizer-api.vercel.app/pesticide")
  ...
  const handleAddToCart = (pesticide) => {
    dispatch(
      addToCart({
        ...
        image: pesticide.images,
        price: pesticide.price,
        quantity: 1,
        description: pesticide.description,
      })
    );
    toast.success(`${pesticide.name} added successfully!`, {
    ...
    <div className="w-full py-10 bg-slate-200">
      <div className="text-center mb-6">
        ...
        <p className="text-gray-600 mt-1">
          Explore our effective pesticide solutions.
        </p>
